...
describe 'navigate' do
  ...
  describe 'index' do
    ...
    it 'has a scope so that only post creators can see their posts' do
      other_user = User.create(first_name: 'Non', last_name: 'Authorized', email: "nonauth@gmail.com", password: "asdfasdf", password_confirmation: "asdfasdf", phone: "5555555555")
  ...
  describe 'new' do
    it 'has a link from the homepage' do
      employee = Employee.create(first_name: 'Employee', last_name: 'Authorized', email: "employee@gmail.com", password: "asdfasdf", password_confirmation: "asdfasdf", phone: "5555555555")
